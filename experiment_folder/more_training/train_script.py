...
environment = AirlineEnvironment(dpc_game, simulator, num_features, num_actions, args.discount, 
                                 args.min_action, args.action_step, args.comp_sellout_price, args.early_termination_penalty)
...
# Save competition results as csv for further analysis
dpc_game.competition_results_df.to_csv('competition_results_df.csv', index=False)
